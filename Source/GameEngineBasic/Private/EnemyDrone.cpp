...
void AEnemyDrone::OnDie(AActor* DeadActor)
{
	...
	// ✔ 바닥에 부딪혔을 때 효과 (Delegate)
	_Mesh->OnComponentHit.AddDynamic(this, &AEnemyDrone::OnDroneHitGround);

	SetLifeSpan(6.f);
}
void AEnemyDrone::OnDroneHitGround(
	...
	const FHitResult& Hit)
{
	...
	// 한 번만 실행되게 제거
	GetMesh()->OnComponentHit.RemoveDynamic(this, &AEnemyDrone::OnDroneHitGround);
}
