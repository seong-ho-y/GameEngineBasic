...
#include "GameEngineBasicOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class GAMEENGINEBASIC_API AGameEngineBasicOffroadCar : public AGameEngineBasicPawn
{
	GENERATED_BODY()
